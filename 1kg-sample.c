...
int main(int argc, char **argv){
  ...
  */
  ...
  for (i=0;i<lanecnt;i++){
    ...
    numreads = numreads + system(command);
  ...
  for (i=0;i<lanecnt;i++){
	...
	while (!isfinished){
	  printf("Sleeping for 10 minutes for sample.\n");
	  sleep(600);
