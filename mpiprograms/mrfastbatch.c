...
*/
    ...
    */
    ...
    sprintf(mvop,"mv /tmp/%s/%s.out.match %s/", myjobid,currentfile,outdir);
    printf("Move_match command: %s\n",mvop);
    system(mvop);

    sprintf(mvop,"mv /tmp/%s/%s.out.match.single.* %s/ 2>/dev/null", myjobid,currentfile,outdir);
    printf("Move_single command: %s\n",mvop);
    system(mvop);

    sprintf(mvop,"mv /tmp/%s/%s.out.match.overmap.* %s/ 2>/dev/null", myjobid,currentfile,outdir);
