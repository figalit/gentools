...
// calkan modified gap penalties

float 		dna_gap_open = 50.0,  dna_gap_extend = 1.0;
...
// calkan change parameters
float  		dna_pw_go_penalty = 50.0,  dna_pw_ge_penalty = 1;
